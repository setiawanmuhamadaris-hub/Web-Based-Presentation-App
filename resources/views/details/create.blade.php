...
<body class="bg-slate-100 min-h-screen">
    ...
    <div class="max-w-2xl mx-auto px-4 py-8">
        ...
        <div class="mb-6 flex items-center gap-3">
            ...
            <div>
                <h2 class="text-xl font-bold text-slate-800">Tambah Detail Tutorial</h2>
        ...
        <div class="bg-white rounded-2xl shadow-sm p-8">
            ...
            <form method="POST"
                  action="{{ route('tutorials.details.store', $tutorial) }}"
                ...
                <div>
                    ...
                    <textarea name="text" rows="4"
                              ...
                              class="w-full px-3.5 py-2.5 border border-slate-300 rounded-lg text-sm
                                     ...
                                     focus:outline-none focus:ring-2 focus:ring-blue-500
                                     focus:border-transparent">{{ old('text') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="code" rows="5"
                              ...
                              class="w-full px-3.5 py-2.5 border border-slate-300 rounded-lg text-sm
                                     ...
                                     focus:outline-none focus:ring-2 focus:ring-blue-500
                                     focus:border-transparent">{{ old('code') }}</textarea>
                </div>
